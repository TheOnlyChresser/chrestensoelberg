...
export const Card: React.FC<{
  ...
  return (
    <article
      className={cn(
        'group glass-box hover:cursor-pointer hover:bg-black/30 hover:border-black/80 hover:text-white active:bg-black/30 active:border-black/80 active:text-white overflow-hidden',
        className,
      )}
      ref={card.ref}
    >
