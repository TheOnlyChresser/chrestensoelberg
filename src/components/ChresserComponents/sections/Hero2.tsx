...
//TODO: imens ting sender er knapper disabled
        ...
        <main className="font-dm-sans min-h-screen w-full items-center bg-white dark:bg-gray-950">
            ...
            {open && !submitted && (
                <div className="fixed inset-0 backdrop-blur-sm bg-black/5 flex justify-center items-center dark:text-gray-50">
                    <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg w-100 md:w-120 relative">
                ...
                <div className="fixed inset-0 backdrop-blur-sm bg-black/5 flex justify-center items-center dark:text-gray-50">
                    <form onSubmit={async (e) => {
                        ...
                        send({
                          ...
                          className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg w-100 md:w-120 relative">
            ...
            {step === null && ordered && productName && notification && (
                <div className="fixed inset-0 backdrop-blur-sm bg-black/5 flex justify-center items-center dark:text-gray-50">
                    <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg w-100 md:w-120 relative">
