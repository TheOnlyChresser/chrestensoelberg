...
export default function Hero() {
    ...
    return (
        <main className="font-dm-sans min-h-screen w-full items-center bg-white dark:bg-gray-950">
            <div className="bg-white dark:bg-gray-950 dark:bg-[radial-gradient(at_36%_10%,hsla(190,70%,25%,1)_0px,transparent_50%),radial-gradient(at_5%_25%,hsla(160,70%,20%,1)_0px,transparent_40%)]
 px-4 flex flex-col pt-40 md:pt-0 md:mt-0 md:justify-center items-center min-h-screen">
                ...
                <BlurFade delay={0.25} inView>
                    <h1 className="dark:text-white mt-4 text-5xl px-4 md:text-7xl font-bold leading-tighter tracking-tight text-center md:max-w-[60vw]">Hjemmesider, som passer til dig</h1>
                </BlurFade>
                ...
                <BlurFade delay={0.25*3} inView className="w-full">
                    <div className="mt-12 flex flex-col md:flex-row w-full items-center justify-center">
                        ...
                        <a href="/#tekstsektion">
                            <p className="text-center group cursor-pointer dark:text-white/80 dark:hover:text-white text-black/80 text-xl flex items-center font-semibold transition-colors duration-300 hover:text-black ml-2 md:ml-0">
                                Læs mere
            ...
            <section id="faq" className="px-8 w-full mb-40">
                ...
                <Accordion type="single" collapsible className="w-full max-w-5xl mx-auto px-6 md:px-16 lg:px-32">
                    ...
                    <AccordionItem value="item-2">
                        ...
                        <AccordionContent className="flex flex-col gap-4 text-[#171717] dark:text-white/80 text-lg leading-relaxed p-2">
                            <p>
                    ...
                    <AccordionItem value="item-3">
                        <AccordionTrigger className="dark:text-white text-2xl font-semibold hover:text-primary dark:hover:text-white/60 transition-colors">
            ...
            {open && !submitted && (
                <div className="fixed inset-0 backdrop-blur-sm bg-black/5 flex justify-center items-center">
                    <form onSubmit={handleSubmit} className="bg-white dark:bg-black rounded-2xl p-6 shadow-lg w-100 relative">
                        <button className="absolute top-0 right-0 p-4 dark:text-white" onClick={()=>{setOpen(false);}}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12"/>
                            </svg>
                        </button>
                        <h2 className="text-lg font-semibold mb-1 text-center dark:text-white">
                        ...
                        <input type="text" placeholder="Dit navn" className="dark:text-white dark:placeholder-white/60 w-full border rounded-md p-2 mb-2" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} required/>
                        <input type="email" placeholder="Din email" className="dark:text-white dark:placeholder-white/60 w-full border rounded-md p-2 mb-4" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} required/>
