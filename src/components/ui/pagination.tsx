import type { ButtonProps } from '@/components/ui/old-ui/button'

import { buttonVariants } from '@/components/ui/old-ui/button'
...
> = ({ className, ref, ...props }) => (
  <ul className={cn('flex flex-row items-center gap-1 dark:text-white', className)} ref={ref} {...props} />
)
