...
export default function SkillCard({name, icon, website, description}: SkillCardProps) {
    ...
    return (
        <>
            <div 
                onClick={handleClick}
                className="cursor-pointer flex-center space-x-2 p-4 bg-white/25 rounded-xl shadow-md hover:shadow-lg active:shadow-lg group focus:scale-110 focus:scale-110 transition-all duration-200"
            >
